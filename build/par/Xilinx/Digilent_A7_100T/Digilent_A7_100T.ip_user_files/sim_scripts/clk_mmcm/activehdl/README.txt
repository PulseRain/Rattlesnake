...
#
# Generated by export_simulation on Sat Oct 19 17:21:36 -0700 2019
#
################################################################################
...
'-reset_run' switch to the './clk_mmcm.sh' script.

./clk_mmcm.sh -reset_run
...
./clk_mmcm.sh -noclean_files

For more information on the script, please type './clk_mmcm.sh -help'.
