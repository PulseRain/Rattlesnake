...
HD_PWD='C:/GitHub/Rattlesnake/build/par/Xilinx/Digilent_A7_100T/Digilent_A7_100T.runs/clk_mmcm_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_mmcm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_mmcm.tcl
