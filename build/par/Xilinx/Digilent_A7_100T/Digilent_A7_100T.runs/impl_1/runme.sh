...
HD_PWD='C:/GitHub/Rattlesnake/build/par/Xilinx/Digilent_A7_100T/Digilent_A7_100T.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Rattlesnake.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Rattlesnake.tcl -notrace
