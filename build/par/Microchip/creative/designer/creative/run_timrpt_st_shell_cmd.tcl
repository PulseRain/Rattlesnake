...
set max_slow_lv_ht [report \
    ...
    -analysis max \
    -format   xml \
    {C:\GitHub\Rattlesnake\build\par\Microchip\creative\designer\creative\creative_max_timing_slow_1.14V_85C.xml} ]
set min_fast_hv_lt [report \
    -type     timing \
    -analysis min \
    -format   xml \
    {C:\GitHub\Rattlesnake\build\par\Microchip\creative\designer\creative\creative_min_timing_fast_1.26V_0C.xml} ]
set max_viol_slow_lv_ht [report \
    -type     timing_violations \
    -analysis max \
    -format   xml \
    {C:\GitHub\Rattlesnake\build\par\Microchip\creative\designer\creative\creative_max_timing_violations_slow_1.14V_85C.xml} ]
set min_viol_fast_hv_lt [report \
    -type     timing_violations \
    -analysis min \
    -format   xml \
    {C:\GitHub\Rattlesnake\build\par\Microchip\creative\designer\creative\creative_min_timing_violations_fast_1.26V_0C.xml} ]
set coverage [report \
    -type     constraints_coverage \
    -format   xml \
    -slacks   no \
    {C:\GitHub\Rattlesnake\build\par\Microchip\creative\designer\creative\creative_timing_constraints_coverage.xml} ]
report \
    -type     combinational_loops \
    -format   xml \
    {C:\GitHub\Rattlesnake\build\par\Microchip\creative\designer\creative\creative_timing_combinational_loops.xml}
set_options -max_opcond best
set_options -min_opcond worst
set has_violations {C:\GitHub\Rattlesnake\build\par\Microchip\creative\designer\creative\creative_has_violations}
